...
func main() {
	...
	mt.Active.Add(mt.Element{Key: []byte("penib"), Value: []byte("danilo")})
	mt.Active.Add(mt.Element{Key: []byte("penic"), Value: []byte("danilo")})
	mt.Active.Add(mt.Element{Key: []byte("penie"), Value: []byte("danilo")})
	mt.Active.Add(mt.Element{Key: []byte("penif"), Value: []byte("danilo")})
	mt.Active.Add(mt.Element{Key: []byte("penig"), Value: []byte("danilo")})
	mt.Active.Add(mt.Element{Key: []byte("penih"), Value: []byte("danilo")})
	mt.Active.Add(mt.Element{Key: []byte("penii"), Value: []byte("danilo")})
	mt.Active.Add(mt.Element{Key: []byte("penij"), Value: []byte("danilo")})
	mt.Active.Add(mt.Element{Key: []byte("penik"), Value: []byte("danilo")})
	mt.Active.Print()
	mt.CheckThreshold()
}
